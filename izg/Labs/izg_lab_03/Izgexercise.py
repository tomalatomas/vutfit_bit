...
#all necessary matrix or vector operations can be found at https://docs.blender.org/api/current/mathutils.html
    ...
    def createView():
        ...
        eyePosition = mathutils.Vector((0.0, -10.0, 0))
        ...
        Z = Z @ mathutils.Matrix.Rotation(math.radians(167),4,'Z')
        Z.normalize()
    ...
    def createTransformation(object, view):
        ...
        #######################
        #transformation = mathutils.Matrix.Translation((0,0,objectNumber))
        #######################
        return view @ mathutils.Matrix.Translation((0,0,-objectNumber)) @ mathutils.Matrix.Rotation(radians(90.0),4,'X')
